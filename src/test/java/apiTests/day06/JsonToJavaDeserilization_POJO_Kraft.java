...
public class JsonToJavaDeserilization_POJO_Kraft {
    ...
    */
        ...
        KraftUser1[] kraftUser1 = response.as(KraftUser1[].class); //--> array içinde olduğu için böyle yazdık.

        //get the length of array
        System.out.println("kraftUser1.length = " + kraftUser1.length);//1

        //get id of the first json/object
        ...
        //get the second skill of first object
        ...
        System.out.println("education.get(0).getId() = " + education.get(0).getId());

        Education education1 = education.get(0);
        //get the first educaiton json
        System.out.println("education1.getId() = " + education1.getId());

        //get the description of first educaiton
